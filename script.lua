-- KARA BÜLLÜK V3 - MM2 PREMIUM PC HUB
...
ScreenGui.Name = "KaraBullukV3_PC"
...
MainFrame.Draggable = true -- Fareyle ekranda istediğin yere sürükle
...
---------------------------------------------------------
-- TAB 1: KARAKTER (SPEED & JUMP - DEĞER YAZMALI)
---------------------------------------------------------
...
---------------------------------------------------------
-- TAB 2: VISUALS & COMBAT (PC Gelişmiş HIGHLIGHT ESP / GODMODE)
---------------------------------------------------------
...
local function CreateESP(player)
    ...
    local function apply()
        ...
        if char and char:FindFirstChild("HumanoidRootPart") and not char:FindFirstChild("Highlight") then
            ...
            -- PC İçin MM2 Akıllı Rol Tespiti (Katil=Kırmızı, Şerif=Mavi, Masum=Yeşil)
...
-- PC İÇİN AÇMA / KAPATMA TUŞU AYARI (SAĞ SHIFT) ;
